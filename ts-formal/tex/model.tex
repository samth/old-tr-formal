...
\begin{lemma}[Object Soundness]
If $\hastyeff{\e{}}{\t{}}{\op{+}}{\op{-}}{\s{}}$ and $\rho \models
\G{}$ and $\evalprime{\e{}}{\vv{}}$ then $\rho(\s{}) = \vv{}$.
\end{lemma}

\begin{lemma}[Filter Soundness True]
If $\hastyeff{\e{}}{\t{}}{\op{+}}{\op{-}}{\s{}}$ and $\rho \models
\G{}$ and $\evalprime{\e{}}{\vv{}}$ and $\vv{} \neq \ff$ then $\rho \models
\op{+}$. 
\end{lemma}

\begin{lemma}[Filter Soundness False]
If $\hastyeff{\e{}}{\t{}}{\op{+}}{\op{-}}{\s{}}$ and $\rho \models
\G{}$ and $\evalprime{\e{}}{\ff}$ then $\rho \models \op{-}$.
\end{lemma}

\begin{lemma}[Type Soundness]
If $\hastyeff{\e{}}{\t{}}{\op{+}}{\op{-}}{\s{}}$ and $\rho \models
\G{}$ and $\evalprime{\e{}}{\vv{}}$ then
$\exists \Gamma' \supseteq \Gamma$  where $\rho' \models \Gamma'$ and
$\hastyeff[\Gamma']{\vv{}}{\t{}'}{\opp{+}}{\opp{-}}{\s{}'}$ and $\subtype{\t{}'}{\t{}}$.
\end{lemma}
