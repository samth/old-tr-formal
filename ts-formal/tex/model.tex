...
\[
  \begin{altgrammar}
    ...
    \alt \cond{\e1}{\e2}{\e3} \ponly{\alt \cons{\e{}}{\e{}}} \alt \vv{}  &\mbox{Expressions} \\
...
This means that in proposition environment $\Delta$ and type
environment $\Gamma$, \e{} has the type \t{}, that evaluating \e{} and
gives us information \phii{} based on whether \e{} evaluates to \ff or
not, and that testing \e{} is the same as testing the object \s{}.
...
\inferrule[T-If]
{
  ...
  \\\\
  \lonly{\derive{\Delta}{\op1}{\opp1}}
  \\
  \lonly{\derive{\Delta}{\op2}{\opp2}}
  \\\\
  \hastyeffphi[\logic{\Delta \cup \op1, }{} \G{} + \logic{\opp1}{\op1}]{\e2}{\t2}{\phii2} {\s2}
  \\\\
  \hastyeffphi[\logic{\Delta \cup \op2, }{} \G{} + \logic{\opp2}{\op2}]{\e3}{\t3}{\phii3} {\s3}
  \\\\
  \subtype{\t2}{\t{}} \\
  \subtype{\t3}{\t{}} \\\\
...
\qquad
\inferrule[L-MP]
{\overvec{\Delta \vdash \p{}} \\ \Delta \vdash \imp{\op{}}{\opp{}}}
{\overvec{\Delta \vdash \p{}'}}
\]
...
\vspace{2mm}\\
    ...
    \applyone{\comp{\t{}}_{{\pbullet}}} {\sig{}} {\s{}} & \bot & \text{ where } \subtype{\sig{}}{\t{}}\\
    \applyone{{\t{}}_{{\pbullet}}} {\sig{}} {\s{}} & \bot & \text{ where } \nooverlap{\sig{}}{\t{}}\\
    \applyone{\ph{}}{\sig{}}{\noeffect} & \bullet & \\
...
{\t{\wpi{\x{}}}::\op{1_+}|\comp{\t{}}_{\wpi{\x{}}}::\op{1_-}}
{\bullet|\bot}
{{\sig{\wpi{\x{}}}::\op{3_+}|\comp{\sig{}}_{\wpi{\x{}}}::\op{3_-}}} 
}
  & \text{ or with predicates} \\
& \ts_{\wpi{\x{}}}::\op+|{\comp{\ts}}_{\wpi{\x{}}}::\op- & \\
...
\combfilter{\op{1_+}|\op{1_-}} {\op{2_+}|\op{2_-}} {\bot|\bullet} & \op{1_+},\op{2_+}|\imp{\op{1_+}}{\op{2_-}},\imp{\op{2_+}}{\op{1_-}} & \text{ and} \vspace{3mm}\\
...
\newcommand{\update}[3][\Gamma(\x{})]{\mathrm{update}({#1},{#3}_{\ponly{#2}})}
