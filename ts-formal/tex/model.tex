...
\[
  \begin{altgrammar}
    ...
    &   & \ponly{\consp \alt \car \alt \cdr} & \mbox{Primitive Operations} 
    \vspace{1mm}
    \\
    \E{} &::=& [] \alt 
    \marg
...
\[
  \begin{altgrammar}
    ...
    \alt \consty{\t{}}{\t{}} \alt
         ...
         \p{} &::=&  \t{\wpi{\x{}}} \alt \compt{\wpi{\x{}}} \alt \bot & \mbox{Filters} \\

         \ph{} & ::=& \t{\ponly{\pi}} \alt \compt{\ponly{\pi}}  \alt \both & \mbox{Latent Filters} \\
