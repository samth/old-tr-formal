...
\begin{lemma}[Removing variables produces subtype]
$\subtype{\t{}}{\subs{\t{}}{\noeffect}{\x{}}}$.
...
\item {\sc T-Let}. 
  ...
  \item Part 1. There are two cases.  If $\s1 = \wpi{\x{}}$, then
    $\s{} = \noeffect$, concluding this part.  Otherwise, let $\rho'$
    ...
    \item Part 2. By application of lemma~\ref{lem:env-remove-prove}
      and cases on \vv{}.
    \item Part 3.  Trivial from the premises and the fact that the
      type of \vv{} cannot mention \x{}, so $\t{}'$.
  \end{enumerate}
