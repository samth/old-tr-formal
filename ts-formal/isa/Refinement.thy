...
datatype ty =
    Top | Int | TT | FF | R builtin | Arr "ty" "ty" "latent_eff" ("_ \<rightarrow> _ : _" [100,100] 100) | Union "ty list"  
...
nominal_primrec
  ...
  |"\<Delta>\<^isub>\<tau> EvenP = (ty.Int \<rightarrow> BoolTy : Latent (R EvenP))"
  |"\<Delta>\<^isub>\<tau> OddP = (ty.Int \<rightarrow> BoolTy : Latent (R OddP))"
  by simp_all
...
nominal_primrec
  ...
  apply (simp add: perm_fun_def perm_nat_def perm_bool)
