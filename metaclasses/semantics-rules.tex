\newcommand{\syntax}
{
 \ensuremath{
       \begin{array}{rcll}
	       ...
	       \M      & \production	& {\class}\ \simpleMethodSyntax & \textrm{class method declaration}\\[2mm]
...
\newcommand{\fullClassSyntax}{\typeDef {\typeArgsBounds \C \X \T \T} \A \A {\class\ \Tfe} \oM {\oT\ \of} \oN}
