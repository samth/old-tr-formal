\newcommand{\syntax}
{
 \ensuremath{
       \begin{array}{rcll}
               \CL     & \production   & \typeDef {\typeArgsBounds \C \X \T \T} \A \A {\static\ \Tfe} \oM {\oT\ \of} \oN  & \textrm{class declaration}\\ [2mm]

               \N      & \production    & \simpleMethodSyntax & \textrm{method declaration}\\
	       \M      & \production	& {\static}\ \simpleMethodSyntax & \textrm{class method declaration}\\[2mm]
			...
			& |				& {\Phi_{\GG}} & \textrm{mapping}\\[2mm]
               ...
               \T      & \production   & \R & \textrm{non-{\tt {typeOf}} type}\\
                       & |             & {\typeof \R}                                          & \mathtt {typeOf} \textrm{ application}\\ [2mm]
...
\newcommand{\fullClassSyntax}{\typeDef {\typeArgsBounds \C \X \T \T} \A \A {\static\ \Tfe} \oM {\oT\ \of} \oN}
...
{
 \newinfruleFour
     { {\typeparams \T}  = {\oX \implSym {\parens {\oI, \oJ}}}}
     {
       \begin{array}{cc}
         {\deltaDef} &
         {\Gamma = \{{\typ {\ov \x} {\ov \T}}, {\typ \this \T}\}}
       \end{array}
     }
     {
       \begin{array}{ccc}
         {\dprovesok {\ov \T}} & {\dprovesok \U} & {\override \m {\super \T} {\arrType {\ov \T} \U}}
       \end{array}
     }
     {
       \begin{array}{ccc}
...
{
 \newrule
     {\trans {\invoke {\Phi_{\GG}^v} \f} {\phivof \GG \f}}
     {R-Field}
}
...
\newcommand{\methComp}
{
 \newinfrule
     ...
     {\trans {\invoke {\Phi_{\GG}^v} {\mof \dd}} {{\substituteTwoArg {\overline {\x}} {\ov \dd}  \this {\Phi_{\GG}^v}} {\ov \e_0}}}
     {R-Invk}
}
